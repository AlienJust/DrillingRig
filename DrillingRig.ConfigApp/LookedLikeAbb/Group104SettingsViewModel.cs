...
namespace DrillingRig.ConfigApp.LookedLikeAbb {
	class Group104SettingsViewModel : ViewModelBase {
		...
		public Group104SettingsViewModel(IUserInterfaceRoot uiRoot, ILogger logger, IAinSettingsReaderWriter readerWriter, IAinSettingsReadNotify ainSettingsReadNotify) {
			_uiRoot = uiRoot;
			_logger = logger;
