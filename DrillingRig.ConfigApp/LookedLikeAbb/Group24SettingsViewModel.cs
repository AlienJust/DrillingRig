...
namespace DrillingRig.ConfigApp.LookedLikeAbb {
	class Group24SettingsViewModel : ViewModelBase {
		...
		public Group24SettingsViewModel(IUserInterfaceRoot uiRoot, ILogger logger, IAinSettingsReaderWriter readerWriter, IAinSettingsReadNotify ainSettingsReadNotify) {
			_uiRoot = uiRoot;
			_logger = logger;
