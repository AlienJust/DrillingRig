...
namespace DrillingRig.ConfigApp.LookedLikeAbb {
	class Group25SettingsViewModel : ViewModelBase {
		...
		public Group25SettingsViewModel(IUserInterfaceRoot uiRoot, ILogger logger, IAinSettingsReaderWriter readerWriter, IAinSettingsReadNotify ainSettingsReadNotify) {
			_uiRoot = uiRoot;
			_logger = logger;
			_readerWriter = readerWriter;
			_ainSettingsReadNotify = ainSettingsReadNotify;

			Parameter01Vm = new ParameterDoubleEditableViewModel("25.01. Уставка моментного тока", "f0", -10000, 10000, null);
