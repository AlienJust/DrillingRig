...
namespace DrillingRig.ConfigApp.LookedLikeAbb {
	class Group26SettingsViewModel : ViewModelBase {
		...
		public Group26SettingsViewModel(IUserInterfaceRoot uiRoot, ILogger logger, IAinSettingsReaderWriter readerWriter, IAinSettingsReadNotify ainSettingsReadNotify) {
			_uiRoot = uiRoot;
			_logger = logger;
			_readerWriter = readerWriter;
			_ainSettingsReadNotify = ainSettingsReadNotify;

			Parameter01Vm = new ParameterDoubleEditableViewModel("26.01. Режим работы", "f0", -10000, 10000, null);
