		...
		private void Load() {
			...
			if (filename != null) {
				...
				foreach (var ainElement in ainElements) {
					...
					var kiW = decimal.Parse(ainElement.Element("KiW").Value, CultureInfo.InvariantCulture);

					var fiNom = decimal.Parse(ainElement.Element("FiNom").Value, CultureInfo.InvariantCulture);
					...
					var fnom = decimal.Parse(ainElement.Element("Fnom").Value, CultureInfo.InvariantCulture);
					var fmax = decimal.Parse(ainElement.Element("Fmax").Value, CultureInfo.InvariantCulture);

					var dflLim = decimal.Parse(ainElement.Element("DflLim").Value, CultureInfo.InvariantCulture);
					var flMinMin = decimal.Parse(ainElement.Element("FlMinMin").Value, CultureInfo.InvariantCulture);

					var ioutMax = short.Parse(ainElement.Element("IoutMax").Value, CultureInfo.InvariantCulture);
					var fiMin = decimal.Parse(ainElement.Element("FiMin").Value, CultureInfo.InvariantCulture);
					...
					var tauR = decimal.Parse(ainElement.Element("TauR").Value, CultureInfo.InvariantCulture);
					var lm = decimal.Parse(ainElement.Element("Lm").Value, CultureInfo.InvariantCulture);
					var lsl = decimal.Parse(ainElement.Element("Lsl").Value, CultureInfo.InvariantCulture);
					var lrl = decimal.Parse(ainElement.Element("Lrl").Value, CultureInfo.InvariantCulture);
					var reserved24 = BytesPair.Parse(ainElement.Element("Reserved24").Value);

					var kpFi = decimal.Parse(ainElement.Element("KpFi").Value, CultureInfo.InvariantCulture);
					var kiFi = decimal.Parse(ainElement.Element("KiFi").Value, CultureInfo.InvariantCulture);

					var reserved28 = BytesPair.Parse(ainElement.Element("Reserved28").Value);

					var kpId = decimal.Parse(ainElement.Element("KpId").Value, CultureInfo.InvariantCulture);
					var kiId = decimal.Parse(ainElement.Element("KiId").Value, CultureInfo.InvariantCulture);

					var reserved32 = BytesPair.Parse(ainElement.Element("Reserved32").Value);

					var kpIq = decimal.Parse(ainElement.Element("KpIq").Value, CultureInfo.InvariantCulture);
					var kiIq = decimal.Parse(ainElement.Element("KiIq").Value, CultureInfo.InvariantCulture);

					var accDfDt = decimal.Parse(ainElement.Element("AccDfDt").Value, CultureInfo.InvariantCulture);
					var decDfDt = decimal.Parse(ainElement.Element("DecDfDt").Value, CultureInfo.InvariantCulture);
					var unom = decimal.Parse(ainElement.Element("Unom").Value, CultureInfo.InvariantCulture);

					var tauFlLim = decimal.Parse(ainElement.Element("TauFlLim").Value, CultureInfo.InvariantCulture);

					var rs = decimal.Parse(ainElement.Element("Rs").Value, CultureInfo.InvariantCulture);
					var fmin = decimal.Parse(ainElement.Element("Fmin").Value, CultureInfo.InvariantCulture);
					var tauM = decimal.Parse(ainElement.Element("TauM").Value, CultureInfo.InvariantCulture);
					var tauF = decimal.Parse(ainElement.Element("TauF").Value, CultureInfo.InvariantCulture);
					var tauFSet = decimal.Parse(ainElement.Element("TauFSet").Value, CultureInfo.InvariantCulture);
					var tauFi = decimal.Parse(ainElement.Element("TauFi").Value, CultureInfo.InvariantCulture);
					...
					var umodThr = decimal.Parse(ainElement.Element("UmodThr").Value, CultureInfo.InvariantCulture);

					var emdecDfdt = decimal.Parse(ainElement.Element("EmdecDfdt").Value, CultureInfo.InvariantCulture);
				...
				if (engineSettingsElement != null) {
					try {
						var settings = new EngineSettingsSimple
						{
							...
							Pnom = decimal.Parse(engineSettingsElement.Element("Pnom").Value, CultureInfo.InvariantCulture),
							CosFi = decimal.Parse(engineSettingsElement.Element("CosFi").Value, CultureInfo.InvariantCulture),
							Eff = decimal.Parse(engineSettingsElement.Element("Eff").Value, CultureInfo.InvariantCulture),
