			...
			if (filename != null) {
				...
				if (engineSettingsElement != null) {
					...
					var settings = new EngineSettingsSimple {
						...
						Pnom = ushort.Parse(engineSettingsElement.Element("Pnom").Value, CultureInfo.InvariantCulture),
						CosFi = ushort.Parse(engineSettingsElement.Element("CosFi").Value, CultureInfo.InvariantCulture),
						Eff = ushort.Parse(engineSettingsElement.Element("Eff").Value, CultureInfo.InvariantCulture),
